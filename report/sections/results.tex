...
Figure \ref{fig:init_logprob} shows the effect of initialization strategy on the log joint probability over time. It shows that not initializing the boundaries at all leads to the highest log joint probability, both initally and after many iterations.
